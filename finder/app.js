...
// Function for sending messages (simulated bot functionality)
function sendMessage() {
  ...
  let botResponse = "";
  switch (true) {
    case userInput.toLowerCase().includes("features"):
      botResponse = "Our platform offers real-time data on investment opportunities, risk analysis, and personalized recommendations.";
      break;
    case userInput.toLowerCase().includes("investment"):
      botResponse = "You can invest in various farming projects, including sustainable agriculture and crop production ventures.";
      break;
    default:
      botResponse = "I'm here to help you with platform features and investment options. Ask me anything!";
      break;
  }
